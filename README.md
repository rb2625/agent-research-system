...
- [x] Single agent with web search tool
- [x] Multi-agent orchestration (planner, parallel researchers, writer)
- [x] Semantic caching, multi-provider fallback, rate limiting
- [x] Live progress tracking API
- [x] Next.js frontend with live status and rendered reports
